...
class GPTModel:
    def __init__(self, d_model, n_heads, d_head, n_layers, device_count, device_cnt_sz, data_type):
        self.d_model = d_model
        self.n_heads = n_heads
        self.d_head = d_head
        self.n_layers = n_layers
        self.device_count = device_count
        self.device_cnt_sz = device_cnt_sz
        ...
        # ]
        self.blocks_decode = [
            TransformerBlockAutoRegressionTP(d_model, n_heads, d_head, device_count, data_type, device_cnt_sz)
            for _ in range(n_layers)
        ]
